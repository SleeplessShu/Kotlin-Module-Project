object TextDisplaying {
    //list
    const val archiveList: String = "Список архивов:"
    const val notesList: String = "Список заметок:"
    ...
    const val incorrectInputName = "Введённое имя занято или введено пустое поле"
    const val note404 = "Заметка не найдена"

    //exit
    const val zeroForExit = "Для выхода введите \"0\""
    const val closeProgram = "Программа завершена, всего доброго."
}